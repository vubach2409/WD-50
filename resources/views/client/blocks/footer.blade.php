    <footer class="footer-section">
        <div class="container relative">
            ...
            <div class="sofa-img">
                <img src="{{ asset('clients/images/sofa.png') }}" alt="Image" class="img-fluid">
            </div>
            ...
            <div class="row g-5 mb-5">
                <div class="col-lg-4">
                    <div class="mb-4 footer-logo-wrap"><a href="#" class="footer-logo">PoLy<span>.</span></a>
                    </div>
                    <p class="mb-4">Cho đến khi nó dễ hơn cả thuốc trang điểm thông thường. Cho đến khi cuộc sống ghét
                        những người chơi ăn malesuada. Anh ta không muốn gì cả và không muốn gì cả. Có kẻ vulputate muốn
                        cơn đau bất chợt buồn bã. Trẻ em sống</p>
                    ...
                    <div class="col-lg-6">
                        <p class="mb-2 text-center text-lg-start">Bản quyền &copy;
                            <script>
                                ...
                                hreff="https://themewagon.com">PoLY</a>
