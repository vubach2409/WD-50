                    ...
                    <div class="col-md-8 col-lg-8 pb-4">
                        ...
                        <form>
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="fname" placeholder="Nhập họ của bạn">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <label class="text-black" for="lname">Tên</label>
                                        <input type="text" class="form-control" id="lname" placeholder="Nhập tên của bạn">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group mb-5">
                                ...
                                <textarea class="form-control" id="message" cols="30" rows="5" placeholder="Nhập nội dung tin nhắn"></textarea>
                            </div>
