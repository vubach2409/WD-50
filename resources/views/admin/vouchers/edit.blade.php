                            ...
                            <td>
                                <select name="type" class="form-control @error('type') is-invalid @enderror">
                                    ...
                                    <option value="percent"
                                        {{ old('type', $voucher->type) == 'percent' ? 'selected' : '' }}>Giảm phần trăm
                                    </option>
                                </select>
                                @error('type')
                                    <small class="text-danger">{{ $message }}</small>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <select name="is_active" class="form-control">
                                    <option value="1"
                                        {{ old('is_active', $voucher->is_active ?? 1) == 1 ? 'selected' : '' }}>Kích hoạt
                                    </option>
                                    <option value="0"
                                        {{ old('is_active', $voucher->is_active ?? 1) == 0 ? 'selected' : '' }}>Ngừng Kích
                                        hoạt</option>
                                </select>
                            </td>
                        </tr>
