        ...
        <div class="card shadow rounded-3">
            ...
            <div class="card-body">
                            ...
                            <li class="list-group-item">
                                ...
                                @if ($variant->color)
                                    <span class="d-inline-block align-middle ms-2">
                                        <span
                                            style="display: inline-block; width: 20px; height: 20px; background-color: {{ $variant->color->code }}; border: 1px solid #ccc; border-radius: 4px; vertical-align: middle;">
                                        </span>
                                        <span class="ms-2">{{ $variant->color->name }}
                                            ({{ $variant->color->code }})</span>
                                    </span>
                                @else
                ...
                <div class="text-center">
                    <a href="{{ route('admin.product_variants.index', $variant->product_id) }}"
                        class="btn btn-secondary mt-3">
                        Quay lại
                    </a>
                    <a href="{{ route('admin.product_variants.edit', [$variant->product_id, $variant->id]) }}"
